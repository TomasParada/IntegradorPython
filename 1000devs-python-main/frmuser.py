...
class User(Toplevel):
    ...
    def aceptar(self):
        try:            
            ...
            if fecha_nac == "":
                tkMsgBox.showerror(self.master.title(), "Fecha Nacimiento es un valor requerido.")
                return
            ...
            if email == "":
                tkMsgBox.showerror(self.master.title(), "Correo Electrónico es un valor requerido.")
                return
            ...
            if confirmacion == "":
                tkMsgBox.showerror(self.master.title(), "Confirme Contraseña es un valor requerido.")
                return
            # agregar los demas
            # .....
